 ...
 * @author seenu_05
 */
public class StudentApplyServelet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (rs.next()) {
                response.getWriter().println("Already applied for this company");
            } else {
                ...
                ps.executeUpdate();
                response.sendRedirect("StudentEligibleCompanies.jsp");
            }
